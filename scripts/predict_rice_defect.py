...
def load_single_image(img_path: str, target_size=(150, 150)) -> np.ndarray:
    """
...
def __main__():
    parser = argparse.ArgumentParser(
        description="Rice Leaf Defect Classification",
    ...
    parser.add_argument(
        ...
        "-m",
        type=str,
        default="../models/tflite/rice_defect_classifier_int8.tflite",
        help="Path to TFLite model (default: models/tflite/rice_defect_classifier_int8.tflite)",
    )
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("RICE LEAF DEFECT CLASSIFICATION RESULTS")
        print("=" * 60)
